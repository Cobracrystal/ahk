...
class WindowManager {
	...
	static guiListviewCreate(exists := 0) {
	...
	static __onContextMenu(ctrlHwnd := 0, eventinfo := 0, isRightclick := 0, x := 0, y := 0) {
	...
	static settingCheckboxHandler(controlhandle := 0, b := 0, c := 0) {
		Gui, WindowManager:Submit, NoHide
